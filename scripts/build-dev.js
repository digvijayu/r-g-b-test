...
checkBrowsers(paths.appPath, isInteractive)
  .then(() => {
    ...
    return measureFileSizesBeforeBuild(paths.appDevBuild);
  })
  ...
  .then(
    ({ stats, previousFileSizes, warnings }) => {
      ...
      const buildFolder = path.relative(process.cwd(), paths.appDevBuild);
...
function build(previousFileSizes) {
  ...
  return new Promise((resolve, reject) => {
    compiler.run((err, stats) => {
      ...
      if (writeStatsJson) {
        return bfj
          .write(paths.appDevBuild + '/bundle-stats.json', stats.toJson())
